    ...
    <main>
            ...
            <div class="service-container-outer">
                <div class="service-container-inner">
                    <div class="service-item">
                        ...
                        <p class="learn-more"><a href="../front-end/services/Burial Services.html" style="text-decoration: none; color: black">Learn More</a></p>
                    </div>
                    <div class="service-item">
                        ...
                        <p class="learn-more"><a href="../front-end/services/Cremation Services.html" style="text-decoration: none; color: black">Learn More</a></p>
                    </div>
                    <div class="service-item">
                        <img src="../front-end/pictures/homepage-pictures/service3.jpg" alt="Planning Ahead">
                        <p class="service-description">Planning Ahead</p>
                        <p class="learn-more"><a href="../front-end/planning/planning.php" style="text-decoration: none; color: black">Learn More</a></p>
                    </div>
                    <div class="service-item">
                        ...
                        <p class="learn-more"><a href="../back-end/obituaries.php" style="text-decoration: none; color: black">Learn More</a></p>
                    </div>
                </div>
            </div>
        ...
        <section class="homepage-3" id="obituaries">
           ...
           <div class="obituaries-info-container">
            ...
            <div class="view-container">
                <button class="original-button" style="margin: 10px auto 80px auto; width: 50%;"><a href="../back-end/obituaries.php" style="text-decoration: none; color: white;">VIEW ALL OBITUARIES</a></button>
            </div><hr>
            <!-- <hr>
            <br>
        </section>
        ...
        <br><br>
            ...
            <div class="review-container-footer">
                ...
                <button class="original-button" id="openReviewFormModal"><a href="../login-signup/review.html" style="text-decoration: none; color: white; font-weight: bold;">Write A Review</a></button>
