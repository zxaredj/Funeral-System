...
<head>
    ...
    <title>Service Arrangements</title>
...
<h1 class="title">SERVICE ARRANGEMENTS FORM</h1>
    ...
    <div id="facility-option1" class="hidden2">    
            ...
            <div class="inputs">
                <div class="inputs">
                    ...
                    <input type="date" id="start-date1" name="start-date1" required>
                </div>
            </div>
            ...
            <div class="inputs">
                <div class="inputs">
                    ...
                    <input type="date" id="end-date1" name="end-date1" required>
                </div>
            </div>
        </div>
            <br>
        ...
        <div id="facility-option2" class="hidden2">
            ...
            <div class="inputs">
                <div class="inputs">
                    ...
                    <input type="date" id="start-date2" name="start-date2" required>
                </div>
            </div>
        </div>
            ...
            <div class="inputs">
                <div class="inputs">
                    ...
                    <input type="date" id="end-date2" name="end-date2" required>
                </div>
            </div>
        </div>
        <br><hr>
        ...
        <div class="inputs">
            <div class="inputs">
                <label for="burial-date">Burial Date</label>
                <input type="date" id="burial-date" name="burial-date" required>
            </div>
        </div>
        <br><hr>
        <br>
    ...
    <div id="facility-option3" class="hidden2">    
            ...
            <div class="inputs">
                <div class="inputs">
                    ...
                    <input type="date" id="start-date3" name="start-date3" required>
                </div>
            </div>
            ...
            <div class="inputs">
                <div class="inputs">
                    ...
                    <input type="date" id="end-date3" name="end-date3" required>
                </div>
            </div>
        </div>
            <br>
        ...
        <div id="facility-option4" class="hidden2">
            ...
            <div class="inputs">
                <div class="inputs">
                    ...
                    <input type="date" id="start-date4" name="start-date4" required>
                </div>
            </div>
        </div>
            ...
            <div class="inputs">
                <div class="inputs">
                    ...
                    <input type="date" id="end-date4" name="end-date4" required>
                </div>
            </div>
        </div>
        <br><hr>
        <br>
        <p class="choose-service">CREMATION ARRANGEMENTS</p>
        <br>

        <div class="inputs">
            <div class="inputs">
                <label for="cremation-date1">Cremation Date</label>
                <input type="date" id="cremation-date1" name="cremation-date1" required>
            </div>
        </div>
        <br><hr>
        <br>
...
<!-- MEMORIAL GATHERING AFTER CREMATION SERVICE -->
  ...
  <br>
    ...
    <div id="facility-option5" class="hidden2">    
        ...
        <div class="inputs">
            <div class="inputs">
                <label for="cremation-date2">Cremation Date</label>
                <input type="date" id="cremation-date2" name="cremation-date2" required>
            </div>
        </div>
        <br><hr>
        <br>
...
<div id="option4" class="hidden1">
  <br>
        ...
        <div class="inputs">
            <div class="inputs">
                <label for="cremation-date3">Cremation Date</label>
                <input type="date" id="cremation-date3" name="cremation-date3" required>
            </div>
        </div>
        <br><hr>
        <br>
    ...
    <div class="inputs">
        ...
        <button class="submit-btn" onclick="window.location.href='service-form.php'">SUBMIT</button>
    </div>
</div>
</div>
</div>
