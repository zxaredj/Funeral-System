    ...
    if(isset($_POST["register"])){
        ...
        if(!empty($email) && !empty($password)){
            if($rowCount > 0){
                ...
                $result = mysqli_query($connect, "INSERT INTO login (username, first_name, last_name, email, password, status) 
                                      VALUES ('$username', '$first_name', '$last_name', '$email', '$password_hash', 0)");
                ...
                if($result){
                    ...
                    $mail->setFrom('perpetualfuneralservice@gmail.com', 'OTP Verification');
